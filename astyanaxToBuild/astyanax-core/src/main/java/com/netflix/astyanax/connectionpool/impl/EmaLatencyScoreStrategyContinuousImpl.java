...
public class EmaLatencyScoreStrategyImpl extends AbstractLatencyScoreStrategyImpl {
    ...
    public EmaLatencyScoreContinuousStrategyImpl(int updateInterval, int resetInterval, int windowSize, int blockedThreshold, double keepRatio, double scoreThreshold) {
        ...
        System.out.println("EmaLatencyScoreContinuousStrategyImpl()");
    }
    
    public EmaLatencyScoreContinuousStrategyImpl(int updateInterval, int resetInterval, int windowSize) {
    ...
    public EmaLatencyScoreContinuousStrategyImpl(int windowSize) {
        super(NAME);
    ...
    public final Instance newInstance() {
        return new Instance() {
            ...
            public double getScore() {
                  System.out.println("EmaLatencyScoreContinuousStrategyImpl.getScore()");
                return cachedScore;
            }
